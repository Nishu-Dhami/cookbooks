Param(
    [Parameter(mandatory)]
    [ValidateSet('RC','SP','NS','VR','PKU','VC','HT','RM','AK','SS','AS','PK','ND','LPC','LPC-DP','LPC-AsDP','LPC-AsBake','LANSAInc', 'KeyVault')]
    [string] $CloudAccount,
...
switch ( $CloudAccount ) {
    ...
    {$_ -eq 'ND'} {
        ...
        $Tenant = '17e16064-c148-4c9b-9892-bb00e9589aa5'
        $Subscription = '739c4e86-bd75-4910-8d6e-d7eb23ab94f3'
        $User = 'NishuDhami@lansacloudlansacom.onmicrosoft.com'
    }
}
